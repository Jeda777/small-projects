const passwordText = document.querySelector('#password') as HTMLElement
...
const generatePassword = () => {
  if ((!lowercase && !uppercase && !numbers && !symbols) || passwordLength < 1) return alert(`You can't do that`)
